...
class ProductImg(models.Model):
    ...
    product = models.ForeignKey(verbose_name='产品', to='Product', on_delete=models.CASCADE, help_text='产品ID')
...
class Product(models.Model):
    ...
    type = models.ForeignKey(to='Type', on_delete=models.CASCADE, related_name='type_id', help_text='产品分类ID')
    description = models.TextField(verbose_name='产品描述', help_text='产品描述')
    cover = models.ImageField(upload_to='static/product/images', verbose_name='产品封面', help_text='产品封面')
